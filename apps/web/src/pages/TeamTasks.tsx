              ...
              return (
                <>
                  ...
                  <div style={{ display: 'grid', gap: 6 }}>
                    <span style={{ fontSize: 12, color: '#475569' }}>첨부</span>
                    <div style={{ border: '1px solid #bae6fd', background: '#f0f9ff', borderRadius: 8, padding: 8, display: 'grid', gap: 6 }}>
                      <div style={{ fontSize: 12, fontWeight: 800, color: '#0369a1' }}>📁 원드라이브 (내부 문서)</div>
                      <button type="button" className="btn btn-sm btn-ghost" style={{ justifySelf: 'start' }} onClick={() => setShowPicker(true)}>원드라이브에서 선택</button>
                    </div>
