    ...
    const bpmnToolSchema = {
      ...
      properties: {
        ...
        bpmnJson: {
          type: 'object',
          properties: {
            nodes: { type: 'array', items: { type: 'object', properties: { id: { type: 'string' }, type: { type: 'string', enum: ['start', 'end', 'task', 'gateway_xor', 'gateway_parallel'] }, name: { type: 'string' }, taskType: { type: 'string', enum: ['WORKLOG', 'COOPERATION', 'APPROVAL'] }, description: { type: 'string' }, assigneeHint: { type: 'string' }, stageLabel: { type: 'string' }, deadlineOffsetDays: { type: 'number' }, slaHours: { type: 'number' } }, required: ['id', 'type', 'name'] } },
...
출력 JSON:
{
  "title": string,
  "bpmnJson": {
    "nodes": Array<{ id, type, name, taskType?, description?, assigneeHint?, stageLabel?, deadlineOffsetDays?, slaHours? }>,
    ...
    const bpmnSchema = {
      ...
      properties: {
        ...
        bpmnJson: {
          type: 'object',
          properties: {
            nodes: { type: 'array', items: { type: 'object', properties: { id: { type: 'string' }, type: { type: 'string' }, name: { type: 'string' }, taskType: { type: 'string' }, description: { type: 'string' }, assigneeHint: { type: 'string' }, stageLabel: { type: 'string' }, deadlineOffsetDays: { type: 'number' }, slaHours: { type: 'number' } }, required: ['id', 'type', 'name'] } },
            edges: { type: 'array', items: { type: 'object', properties: { id: { type: 'string' }, source: { type: 'string' }, target: { type: 'string' }, condition: { type: 'string' }, isLoopBack: { type: 'boolean' } }, required: ['id', 'source', 'target'] } },
          },
          required: ['nodes', 'edges'],
        },
